...
opt.register('inputDir',  '/afs/cern.ch/work/p/pasenov/CMSSW_10_1_11/src/Geometry/PixelTelescope/test/RAW/',
	     opts.VarParsing.multiplicity.singleton, opts.VarParsing.varType.string,
	     'Directory of input raw files')

opt.register('outputFileName', 'PixelTelescope_BeamData_RAW_L5_L8.root',
	     opts.VarParsing.multiplicity.singleton, opts.VarParsing.varType.string,
	     'Name of output reco file')

opt.register('outputDQMFileName', 'PixelTelescope_BeamData_DQM_L5_L8.root',
	     opts.VarParsing.multiplicity.singleton, opts.VarParsing.varType.string,
...
#process.DQMData = cms.EDAnalyzer('AnaNikkie', 
	...
	FirstSeedLayer = cms.int32(4),
	SecondSeedLayer = cms.int32(7)
