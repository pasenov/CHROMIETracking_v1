...
//        std::cout << "x glo " << x << " x loc " << x2 << std::endl;
  ...
  std::cout << "analyze:number of seeds " << theTeleTrackCollection.size() << std::endl;
  ...
  std::cout << "analyze:number of tracks " << theTeleTrackCollection.size() << std::endl;
  
   std::cout << "analyze:Tracking Done" << std::endl;

 
  // Start Filling the "TrackTree" Tree
  // -----------------------------------------------
...
void SimpleTracking::beginJob ( ) {
  ...
  // load the noisy channel list
   ...
   file_noisy.open("/afs/cern.ch/work/p/pasenov/CMSSW_10_1_11/src/Geometry/PixelTelescope/test/noisy_list.txt");
   inoisy=0;
